...
ーTask information file (cvat_taskinfo) that includes plankton collection locations, etc.
ーAnnotation name file (anno_name_list) containing labels for each classification class/.
